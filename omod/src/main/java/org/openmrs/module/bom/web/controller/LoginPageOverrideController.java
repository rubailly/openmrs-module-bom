...
@Controller
public class LoginPageOverrideController {
	...
	@RequestMapping("/index.htm")
	 public String showOurLoginFormIndex() {
	...
	@RequestMapping("/module/bom/bomHome.htm")
	 public String showOurHomepage() {
		return "/module/bom/bomHome";
	 }
	...
	private String determineRedirect(HttpServletRequest request) {
		...
		String redirect = request.getContextPath() + "/module/bom/bomHome.htm";
