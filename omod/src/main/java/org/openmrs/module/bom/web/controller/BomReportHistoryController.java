...
@Controller
public class BomReportHistoryController {
	...
	@RequestMapping("/module/bom/bomReportHistory")
	...
	@RequestMapping("/module/bom/deleteReportRequest")
	...
	@RequestMapping("/module/bom/loadReportStatus")
	...
	@RequestMapping("/module/bom/viewErrorDetails")
	...
	@RequestMapping("/module/bom/reportHistorySave")
	public String saveHistoryElement(@RequestParam("uuid") String uuid, @RequestParam(value="description", required=false) String description) {
		...
		return "redirect:/module/bom/bomReportHistoryOpen.form?uuid="+uuid;
	}
	
	@RequestMapping("/module/bom/bomReportHistoryOpen")
	public String openFromHistory(@RequestParam("uuid") String uuid, HttpServletResponse response, WebRequest request, ModelMap model) throws IOException {
		...
		if (req == null) {
			...
			return "redirect:/module/bom/bomReportHistory.form";
		}
		...
		return "/module/bom/bomReportHistoryOpen";
	}
	
	@RequestMapping("/module/bom/viewReport")
	public ModelAndView viewReport(@RequestParam("uuid") String uuid, HttpServletResponse response, HttpServletRequest request) throws IOException {
		...
		String linkUrl = "/module/bom/reportHistoryOpen";
	...
	@RequestMapping("/module/bom/reportHistoryProcess")
